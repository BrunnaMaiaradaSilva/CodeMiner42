...
class SurvivorsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create survivor" do
    assert_difference('Survivor.count') do
      post survivors_url, params: { survivor: { age: @survivor.age, decimal: @survivor.decimal, gender: @survivor.gender, integer: @survivor.integer, latitude: @survivor.latitude, longitude: @survivor.longitude, name: @survivor.name, string: @survivor.string } }
    end
  ...
  test "should update survivor" do
    patch survivor_url(@survivor), params: { survivor: { age: @survivor.age, decimal: @survivor.decimal, gender: @survivor.gender, integer: @survivor.integer, latitude: @survivor.latitude, longitude: @survivor.longitude, name: @survivor.name, string: @survivor.string } }
