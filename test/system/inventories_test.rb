...
class InventoriesTest < ApplicationSystemTestCase
  ...
  test "creating a Inventory" do
    ...
    fill_in "Ammunition", with: @inventory.ammunition
    fill_in "Food", with: @inventory.food
    fill_in "Integer", with: @inventory.integer
    fill_in "Medication", with: @inventory.medication
    fill_in "Water", with: @inventory.water
